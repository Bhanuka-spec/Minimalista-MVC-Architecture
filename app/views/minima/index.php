        ...
        <article>
          <header class="section background-white">
            <div class="line text-center">        
              ...
              <p class="margin-bottom-0 text-size-16 text-dark"><h3>Welcome to Minimalista</h3><br><br>
              At Minimalista, we believe that less is more. Our mission is to help you create spaces that are simple yet stylish, functional yet beautiful. With a focus on clean lines, open spaces, and timeless design, we bring minimalist principles into every room, helping you craft a home that feels both inspiring and serene.<br><br>
              Explore our curated collections, design tips, and personalized services to transform your space into the sanctuary you've always dreamed of. Whether you're starting from scratch or looking for a refresh, Minimalista is here to guide you toward a more balanced, beautiful home.</p>
            </div>  
          </header>
